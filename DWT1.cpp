...
DWT1::DWT1( sc_module_name n ): sc_module( n )
{
	SC_THREAD( conv );
	sensitive << i_clk.pos();
	dont_initialize();
...
#endif            
// cout << "m = " << m << " L1: receive " << spike_1/128.0 << " and " << spike_2/128.0 << endl;
                        {
...
// cout << "temp: " << temp_A[0] << " " << temp_A[1] << " " << temp_A[2] << " " << temp_A[3] << " " << temp_A[4] << " " << temp_A[5] << " " << temp_A[6] << " " << temp_A[7] << endl;
...
// if (m >= L1_N + 3) {
//         // cout << "L1: write out D: " << 0 << " and A: " << 0 << endl;
// }
// else if (m > 2) {
//         cout << "L1: write out D: " << val_D << " and A: " << val_A << endl;
//         // cout << "spike: " << spike_buffer[0] << " " << spike_buffer[1] << " " << spike_buffer[2] << " " << spike_buffer[3] << " " << spike_buffer[4] << " " << spike_buffer[5] << " " << spike_buffer[6] << " " << spike_buffer[7] << endl;
// }
// else;
#else
